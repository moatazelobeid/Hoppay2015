...
$crawler->setURL("http://www.sukar.com/ae-en/");
...
if (!file_exists("./tmp/sukar_id.tmp")) 
{ 
  $crawler_ID = $crawler->getCrawlerId(); 
  file_put_contents("./tmp/sukar_id.tmp", $crawler_ID); 
} 
else 
{ 
  $crawler_ID = file_get_contents("./tmp/sukar_id.tmp"); 
